...
type FileResource func(map[string]interface{}, connections.Connection) (*connections.FileResult, error)

func NewLuaFileWrapper(r FileResource) func(L *lua.LState) int {
